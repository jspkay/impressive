export const impress=`\/\/ This file was automatically generated from files in src\/ directory.
...
( function( document ) {
    ...
    document.addEventListener( "impress:init", function( event ) {
        ...
        \/* gc.addEventListener( document, "click", function( event ) {
            console.log("Prevented from doing shit :)")
            return
            var target = event.target;
            try {
